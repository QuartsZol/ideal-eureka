...
local Themes = {
    ...
    VoidHub = {
		MainFrame = Color3.fromRGB(30,30,30),
		Minimise = Color3.fromRGB(74,46,123),
		MinimiseAccent = Color3.fromRGB(74,46,123),
		Maximise = Color3.fromRGB(74,46,123),
		MaximiseAccent = Color3.fromRGB(74,46,123),
		NavBar = Color3.fromRGB(40,40,40),
		NavBarAccent = Color3.fromRGB(230,230,230),
		NavBarInvert = Color3.fromRGB(230,230,230),
		TitleBar = Color3.fromRGB(40,40,40),
		TitleBarAccent = Color3.fromRGB(230,230,230),
		Overlay = Color3.fromRGB(85,85,85),
		Banner = Color3.fromRGB(55,55,55),
		BannerAccent = Color3.fromRGB(130,130,130),
		Content = Color3.fromRGB(85,85,85),
		Button = Color3.fromRGB(85,85,85),
		ButtonAccent = Color3.fromRGB(130,130,130),
		ChipSet = Color3.fromRGB(85,85,85),
		ChipSetAccent = Color3.fromRGB(130,130,130),
		DataTable = Color3.fromRGB(85,85,85),
		DataTableAccent = Color3.fromRGB(130,130,130),
		Slider = Color3.fromRGB(85,85,85),
		SliderAccent = Color3.fromRGB(235,235,235),
		Toggle = Color3.fromRGB(85,85,85),
		ToggleAccent = Color3.fromRGB(130,130,130),
		Dropdown = Color3.fromRGB(85,85,85),
		DropdownAccent = Color3.fromRGB(235,235,235),
		ColorPicker = Color3.fromRGB(85,85,85),
		ColorPickerAccent = Color3.fromRGB(130,130,130),
		TextField = Color3.fromRGB(230,230,230),
		TextFieldAccent = Color3.fromRGB(230,230,230),
	}
}
